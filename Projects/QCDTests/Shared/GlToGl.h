...
#define lsclDenNumFactorizeArguments "{gs\,la\,flagD1v1\,flagD1v2\,flagDMv1\,flagDMv2\,flagD5\,lsclFlag1\,lsclFlag2\,flagQuProp\,flagnnb\,flagnbn}"

* Define variables contained in lsclNum and lsclDen that will trigger a factorization of those terms.
#define lsclFactorizationVariables "meta,gkin,mqb,u0b,lsclSUNN,lsclNA,lsclCF,lsclCA,lsclCRmCA2"
