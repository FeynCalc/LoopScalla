...
# Examples:
# /ShellScripts/lsclAddUpDiagrams.sh MyProject MyProject MyModel 3 1
# /ShellScripts/lsclAddUpDiagrams.sh MyProject MyProject MyModel 3 1 --force
# /ShellScripts/lsclAddUpDiagrams.sh MyProject MyProject MyModel 3 --fromto 1 10
# /ShellScripts/lsclAddUpDiagrams.sh MyProject MyProject MyModel 3 --fromto 1 all --force
