...
# Examples:
# /ShellScripts/lsclExtractDiagramTopology.sh MyProject MyProject MyModel 3 1
# /ShellScripts/lsclExtractDiagramTopology.sh MyProject MyProject MyModel 3 1 --force
# /ShellScripts/lsclExtractDiagramTopology.sh MyProject MyProject MyModel 3 --fromto 1 10
# /ShellScripts/lsclExtractDiagramTopology.sh MyProject MyProject MyModel 3 --fromto 1 all --force

# Stop if any of the commands fails
set -e

export LSCL_SCRIPT_NAME="lsclExtractDiagramTopology"
...
if [[ ${lsclOptFromTo} -eq 1 ]] ; then
    ...
    export LSCL_SCRIPT_TO_RUN_IN_PARALLEL="lsclExtractDiagramTopology.sh"
