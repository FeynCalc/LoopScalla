...
# ./ShellScripts/lsclSlurmFireImportResults.sh MyProject MyProject MyModel 1 clusterPartitions --fromto 1 all
# ./ShellScripts/lsclSlurmFireImportResults.sh MyProject MyProject MyModel 1 clusterPartitions --mem 2500 --fromto 1 all --force
...
export LSCL_SLURM_SCRIPT_NAME="lsclSlurmFireImportResults"
...
export LSCL_CLUSTER_SCRIPT_NAME="lsclFireImportResults.sh"
