...
# ./ShellScripts/lsclFirePrepareReduction.sh MyProject MyProject MyModel 3 topology1
# ./ShellScripts/lsclFirePrepareReduction.sh MyProject MyProject MyModel 3 topology1 --force
# ./ShellScripts/lsclFirePrepareReduction.sh MyProject MyProject MyModel 3 --fromto 1 2
# ./ShellScripts/lsclFirePrepareReduction.sh MyProject MyProject MyModel 3 --fromto 1 all --force

# Stop if any of the commands fails
set -e

export LSCL_SCRIPT_NAME="lsclFirePrepareReduction"
export LSCL_SHELL_SCRIPT_NAME="AuxiliaryScripts/lsclAuxFirePrepareReduction.sh"
...
while [[ ${#} -gt 0 ]]; do
  case ${1} in
    ...
    --pjobs)
      ...
      #echo "${LSCL_SLURM_SCRIPT_NAME}: Setting the number of requested nodes for all jobs to ${LSCL_CLUSTER_NUMBER_OF_REQUESTED_NODES}."
      shift
      shift
      ;;
...
if [[ ${lsclOptFromTo} -eq 1 ]] ; then
    ...
    export LSCL_SCRIPT_TO_RUN_IN_PARALLEL="lsclFirePrepareReduction.sh"
...
# Examples:
# Notice that numbers are related to the positions of the entries in the TopologyList.txt file
# ./ShellScripts/lsclFirePrepareReduction.sh MyProject MyProject MyModel 3
# ./ShellScripts/lsclFirePrepareReduction.sh MyProject MyProject MyModel 3 --force
...
if [[ ${LSCL_FLAG_FORCE} -eq 0 ]]; then
      export LSCL_RUN_ONLY_IF_RESULT_FILE_NOT_PRESENT="${lsclRepoDir}/Projects/${lsclProjectName}/Diagrams/Output/${lsclProcessName}/${lsclModelName}/${lsclNLoops}/Topologies/TopologyList.txt"
fi

${lsclScriptDir}/lsclTemplateScriptShell.sh ${lsclBasicArguments[@]:0:4} "dummy"
