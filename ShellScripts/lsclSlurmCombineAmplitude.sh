...
# Examples:
# ./ShellScripts/lsclSlurmCombineDiagrams.sh MyProject MyProject MyModel 1 clusterPartitions --fromto 1 all --diaNumber=379
# ./ShellScripts/lsclSlurmCombineDiagrams.sh MyProject MyProject MyModel 1 clusterPartitions --mem 2500 --fromto 1 all --force --diaNumber=379
# ./ShellScripts/lsclSlurmCombineDiagrams.sh MyProject MyProject MyModel 1 clusterPartitions --mem 2500 --fromto 1 all --force --nodes 2 --slices 1000 --diaNumber=379
# ./ShellScripts/lsclSlurmCombineDiagrams.sh MyProject MyProject MyModel 1 clusterPartitions --mem 2500 --fromto 1 all --clearlogs --nodes 2 --slices 1000 --diaNumber=379
# ./ShellScripts/lsclSlurmCombineDiagrams.sh MyProject MyProject MyModel 1 clusterPartitions --mem 1000 --fromto 1 all --nodes 2 --slices 5 --clearlogs  --diaNumber=379


# Stop if any of the commands fails
set -e

export LSCL_SLURM_SCRIPT_NAME="lsclSlurmCombineDiagrams"
...
export LSCL_CLUSTER_SCRIPT_NAME="lsclCombineDiagrams.sh"
