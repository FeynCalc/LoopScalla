...
# Examples:
# /ShellScripts/lsclIdentifyTopology.sh MyProject MyProject MyModel 3 1
# /ShellScripts/lsclIdentifyTopology.sh MyProject MyProject MyModel 3 1 --force
# /ShellScripts/lsclIdentifyTopology.sh MyProject MyProject MyModel 3 --fromto 1 10
# /ShellScripts/lsclIdentifyTopology.sh MyProject MyProject MyModel 3 --fromto 1 all --force

# Stop if any of the commands fails
set -e

export LSCL_SCRIPT_NAME="lsclIdentifyTopology"
...
export LSCL_CREATE_DIR_IF_NOT_PRESENT_2="${lsclRepoDir}/Projects/${lsclProjectName}/Diagrams/${lsclProcessName}/${lsclModelName}/${lsclNLoops}/Stage1"
...
if [[ ${LSCL_FLAG_FORCE} -eq 0 ]] && [[ ${lsclOptFromTo} -ne 1 ]]; then
      export LSCL_RUN_ONLY_IF_RESULT_FILE_NOT_PRESENT="${lsclRepoDir}/Projects/${lsclProjectName}/Diagrams/${lsclProcessName}/${lsclModelName}/${lsclNLoops}/Stage1/stage1_dia${lsclDiaNumber}L${lsclNLoops}.res"
fi
...
if [[ ${lsclOptFromTo} -eq 1 ]] ; then
    ...
    export LSCL_SCRIPT_TO_RUN_IN_PARALLEL="lsclIdentifyTopology.sh"
