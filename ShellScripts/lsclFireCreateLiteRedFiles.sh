...
# ./ShellScripts/lsclFireCreateLiteRedFiles.sh MyProject MyProject MyModel 3 topology1
# ./ShellScripts/lsclFireCreateLiteRedFiles.sh MyProject MyProject MyModel 3 topology1 --force
# ./ShellScripts/lsclFireCreateLiteRedFiles.sh MyProject MyProject MyModel 3 --fromto 1 2
# ./ShellScripts/lsclFireCreateLiteRedFiles.sh MyProject MyProject MyModel 3 --fromto 1 all --force

# Stop if any of the commands fails
set -e

export LSCL_SCRIPT_NAME="lsclFireCreateLiteRedFiles"
export LSCL_SHELL_SCRIPT_NAME="AuxiliaryScripts/lsclAuxFireCreateLiteRedFiles.sh"
