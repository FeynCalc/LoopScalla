...
# ./ShellScripts/lsclEvaluateWithPySecDec.sh MyProject MyProject MyModel 3 topology1
# ./ShellScripts/lsclEvaluateWithPySecDec.sh MyProject MyProject MyModel 3 topology1 --force
# ./ShellScripts/lsclEvaluateWithPySecDec.sh MyProject MyProject MyModel 3 --fromto 1 2
# ./ShellScripts/lsclEvaluateWithPySecDec.sh MyProject MyProject MyModel 3 --fromto 1 all --force

# Stop if any of the commands fails
set -e

export LSCL_SCRIPT_NAME="lsclEvaluateWithPySecDec"
export LSCL_SHELL_SCRIPT_NAME="AuxiliaryScripts/lsclAuxEvaluateWithPySecDec.sh"
